  ...
  const validateForm = () => {
    ...
    rows.forEach((row, index) => {
      ...
      if (!row.quantity.trim())
        validationErrors[`quantity-${index}`] = "Quantity is required";
        ...
        <form onSubmit={handleSubmit}>
          <div className="card shadow-sm py-3 px-4 mb-3">
            <div className="d-flex align-items-center">
              ...
              <h5 className="fw-semibold ms-3 mb-0">Purchase Order</h5>
            </div>
          </div>
          ...
          <div className="card shadow-sm mb-3">
            ...
            <div className="card-body px-4 py-3">
              <AddItem rows={rows} setRows={setRows} errors={errors} />
            </div>
          </div>
          <div>
          ...
          <div className="row align-items-start">
            <div className="col-md-5">
              <div className="card shadow-sm mb-3">
                <div className="bg-info rounded-top px-4 py-3">
                  <h6 className="fw-semibold m-0">Email Recipient</h6>
                </div>
                <div className="card-body px-4 py-3">
                  <select
                    class="form-select"
