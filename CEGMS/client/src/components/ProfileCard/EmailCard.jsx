      ...
      <div className={styles.cardContainer}>
        ...
        <div className={styles.infoContainer}>
            ...
            <div className={styles.boxesContainer}>
              <Link to="/Profile">
                <div className={styles.grayBox}>
                  <img src={personI} className={styles.logo}></img>
              ...
              <Link to="/Profile/Email">
                ...
                >
                  <img src={mail} className={styles.logo}></img>
          ...
          <div className="mb-3 mt-3 p-3" style={{ width: "100%" }}>
            <label for="" className="form-label fs-6 fw-semibold">
              Email
            </label>
            <input
              type="email"
          ...
          <div className="d-flex justify-content-center align-items-end p-3">
            ...
            <div className="mb-3">
              <button className="btn btn-primary mx-3">Resend</button>
