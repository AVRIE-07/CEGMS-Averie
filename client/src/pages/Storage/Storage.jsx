    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          "http://localhost:3000/api/storageProducts"
        );
    ...
    try {
      ...
      if (isEditMode) {
        ...
        response = await axios.put(
          `http://localhost:3000/api/storageProducts/${currentProductId}`,
          updatedProductData
        );
  ...
  const confirmDelete = async () => {
    try {
      for (let id of selectedProducts) {
        await axios.delete(`http://localhost:3000/api/storageProducts/${id}`);
      }
      setProducts((prevProducts) =>
        prevProducts.filter(
            ...
            <div className="d-flex align-items-center">
              ...
              <Dropdown>
                ...
                <Dropdown.Menu>
                  ...
                  <Dropdown.Item as={Link} to="/Storage/AddSupplier">
                    Supplier
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
