          ...
          {isEditMode && (
            <div className="mb-3">
              ...
              <input
                ...
                onChange={(e) => {
                  // Regex to allow only numbers (and prevent letters or symbols)
                  const regex = /^[0-9]*$/;
                  const inputValue = e.target.value;

                  if (regex.test(inputValue) || inputValue === "") {
                    handleInputChange(e); // Proceed with the valid input
                  } else {
                    // Show an alert if non-numeric input is detected
