...
import BackorderReportPDF from "./PDFReports/ReportBO"

export default function ReportBO({ open, handleClose }) {
  ...
  const handleGenerate = async () => {
    try {
      ...
      const response = await backorderService.getReport(params);
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  <PDFViewer width="100%" height="600">
                      <BackorderReportPDF data={reportData} />
                  </PDFViewer>
                </div>
