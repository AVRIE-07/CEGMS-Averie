...
import GRNReportPDF from "./PDFReports/ReportGRN"

export default function ReportGRN({ open, handleClose }) {
  ...
  const handleGenerate = async () => {
    try {
      ...
      const response = await grnService.getReport(params);
      console.log("Report data:", response.data);
      setReportData(response.data);
      handleClose();
      setShowPDF(true);
  
      // TODO: Pass to a table, export, or display inside modal
    } catch (error) {
