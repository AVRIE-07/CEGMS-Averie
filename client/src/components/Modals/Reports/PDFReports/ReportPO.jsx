      ...
      <Page style={styles.page} size="A4" orientation="landscape">
        ...
        <View style={styles.table}>
          <View style={styles.tableRow}>
            ...
            <Text style={styles.tableColHeader}>Product Description</Text>
            <Text style={styles.tableColHeader}>Order Quantity</Text>
            <Text style={styles.tableColHeader}>Product Status</Text>
            ...
            <React.Fragment key={index}>
              {order.items.map((item, itemIndex) => (
                <View
                  ...
                  key={`${index}-${itemIndex}`}
                >
                  <Text style={styles.tableCol}>{generateCustomPurchaseOrderId(order._id)}</Text>
                  <Text style={styles.tableCol}>{order.supplier.company_name}</Text>
