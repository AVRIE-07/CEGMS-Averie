      ...
      <Page style={styles.page} size="A4" orientation="landscape">
        ...
        <View style={styles.table}> 
          <View style={styles.tableRow}>
            <Text style={styles.tableColHeader}>GRN ID</Text>
            ...
            <Text style={styles.tableColHeader}>Received Date</Text>
            ...
            <React.Fragment key={index}>
              {order.items.map((item, itemIndex) => (
                <View
                  ...
                  key={`${index}-${itemIndex}`}
                >
                  <Text style={styles.tableCol}>{generateCustomGRNId(order._id)}</Text>
                  ...
                  <Text style={styles.tableCol}>{formatDate(order.delivered_date)}</Text>
